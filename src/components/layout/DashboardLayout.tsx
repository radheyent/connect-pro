        ...
        <header className="h-16 bg-white border-b border-slate-200 px-6 flex items-center justify-between shadow-sm z-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative hidden sm:block">
              <button
                className="p-2 text-slate-400 border border-slate-200 rounded-md bg-white hover:bg-slate-50 relative"
              ...
              {showActivity && (
                <div className="absolute right-0 top-12 w-80 bg-white border border-slate-200 rounded-2xl shadow-2xl z-50 p-4">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-sm font-bold text-slate-800">Recent Activity</span>
                    <button onClick={() => setShowActivity(false)} className="text-slate-400 hover:text-slate-600">✕</button>
                  </div>
                  <RecentActivityPanel />
                </div>
              )}
